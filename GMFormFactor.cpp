...
// For H5:
    BRH5<<"# mphi dM BRH50AA BRH50ZA BRH50ZZ BRH50WW GammaH50 BRH50AAEFT BRH50ZAEFT BRH50ZZEFT BRH50WWEFT GammaH50EFT BRH5pWA BRH5pWZ GammaH5p BRH5pWAEFT BRH5pWZEFT GammaH5pEFT BRH5ppWW GammaH5pp BRH5ppWWEFT GammaH5ppEFT"<<endl;
    for (mphi = 80.0; mphi<=500 ; mphi+=5)
    {
        for (dM = 0; dM < 200; dM+=10)
        {
            ...
            BRH5<<mphi<<"  "<<dM<<"  "<<GH50AA/GH50tot<<"  "<<GH50ZA/GH50tot<<"  "<<GH50ZZ/GH50tot<<"  "<<GH50WW/GH50tot<<"  "<<GH50tot;
            ...
            BRH5<<"  "<<GH50AA/GH50tot<<"  "<<GH50ZA/GH50tot<<"  "<<GH50ZZ/GH50tot<<"  "<<GH50WW/GH50tot<<"  "<<GH50tot;

            GH5pWA = decay.GetGammaHVV(H5p,W,A);
            GH5pWZ = decay.GetGammaHVV(H5p,W,Z);
            GH5ptot = decay.GetGammaHtot(H5p);
            BRH5<<"  "<<GH5pWA/GH5ptot<<"  "<<GH5pWZ/GH5ptot<<"  "<<GH5ptot;
            ...
            BRH5<<"  "<<1.0<<"  "<<GH5ppWW<<endl;

        }
    }
// For H:
    BRH<<"# mphi dM BRHAA BRHZA BRHZZ BRHWW GammaH BRHAAEFT BRHZAEFT BRHZZEFT BRHWWEFT GammaHEFT"<<endl;
    for (mphi = 80.0; mphi<=500 ; mphi+=5)
    {
        for (dM = 0; dM < 200; dM+=10)
        {
            ...
            BRH<<mphi<<"  "<<dM<<"  "<<GHAA/GHtot<<"  "<<GHZA/GHtot<<"  "<<GHZZ/GHtot<<"  "<<GHWW/GHtot<<"  "<<GHtot;
            ...
            BRH<<"  "<<GHAA/GHtot<<"  "<<GHZA/GHtot<<"  "<<GHZZ/GHtot<<"  "<<GHWW/GHtot<<"  "<<GHtot<<endl;

        }
    }
// For H3:
    BRH3<<"# mphi dM BRH30AA BRH30ZA BRH30ZZ BRH30WW GammaH30 BRH30AAEFT BRH30ZAEFT BRH30ZZEFT BRH30WWEFT GammaH30EFT BRH3pWA BRH3pWZ GammaH3p BRH3pWAEFT BRH3pWZEFT GammaH3pEFT"<<endl;
    for (mphi = 80.0; mphi<=500 ; mphi+=5)
    {
        for (dM = 0; dM < 200; dM+=10)
        {
            Mod.MH3 = mphi;
            Mod.MH = sqrt(mphi*mphi+1.0/2.0*dM*dM);
            Mod.MH5 = sqrt(mphi*mphi-dM*dM);
            Mod.M2 = 80.0;
            decay.SetModel(Mod);
            ...
            BRH3<<mphi<<"  "<<dM<<"  "<<GH30AA/GH30tot<<"  "<<GH30ZA/GH30tot<<"  "<<GH30ZZ/GH30tot<<"  "<<GH30WW/GH30tot<<"  "<<GH30tot;
