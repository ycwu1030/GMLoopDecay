...
int main() {
    ...
    for (dM = 0; dM < 250; dM+=5)
    {
        ...
        Mod.M2 = 80.0;
        decay.SetModel(Mod);
        decay.SetIntegralMethod(Q2VEGAS);
        ...
        cout<<"=========================================="<<endl;
        cout<<"  Q2VEGAS"<<endl;
        cout<<dM<<" "<<Mod.MH<<" "<<Mod.MH3<<" "<<Mod.MH5<<" "<<GHtot<<" "<<GH30tot<<" "<<GH3ptot<<" "<<GH50tot<<" "<<GH5ptot<<endl;
        decay.SetIntegralMethod(Q2MISER);
        // GHAA = decay.GetGammaHPartial(H,A,A);
        // GHZA = decay.GetGammaHPartial(H,Z,A);
        // GHZZ = decay.GetGammaHPartial(H,Z,Z);
        // GHWW = decay.GetGammaHPartial(H,W,W);
        ...
        cout<<"  Q2MISER"<<endl;
        cout<<dM<<" "<<Mod.MH<<" "<<Mod.MH3<<" "<<Mod.MH5<<" "<<GHtot<<" "<<GH30tot<<" "<<GH3ptot<<" "<<GH50tot<<" "<<GH5ptot<<endl;
        decay.SetIntegralMethod(RHOVEGAS);
        // GHAA = decay.GetGammaHPartial(H,A,A);
        // GHZA = decay.GetGammaHPartial(H,Z,A);
        // GHZZ = decay.GetGammaHPartial(H,Z,Z);
        // GHWW = decay.GetGammaHPartial(H,W,W);
        ...
        cout<<"  RHOVEGAS"<<endl;
        cout<<dM<<" "<<Mod.MH<<" "<<Mod.MH3<<" "<<Mod.MH5<<" "<<GHtot<<" "<<GH30tot<<" "<<GH3ptot<<" "<<GH50tot<<" "<<GH5ptot<<endl;
        decay.SetIntegralMethod(RHOMISER);
        // GHAA = decay.GetGammaHPartial(H,A,A);
        // GHZA = decay.GetGammaHPartial(H,Z,A);
        // GHZZ = decay.GetGammaHPartial(H,Z,Z);
        // GHWW = decay.GetGammaHPartial(H,W,W);
